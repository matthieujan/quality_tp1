...
public class Ascenseur extends Thread 
{
    ...
    static private boolean DEBUG =false && Constantes.DEBUG;
    ...
    public void run()
    {
		...
		{	
		    ...
		    {				
				...
				sim.ajouter_evenement(new EvtAscenseurArret(etage));
				...
				sim.ajouter_evenement(new EvtAscenseurFinArret());
	    	...
	    	sim.ajouter_evenement(new EvtAscenseurDirection(dir));
		    ...
		    sim.ajouter_evenement(new EvtAscenseurEtage(etage));
	...
	if (DEBUG) System.out.println(" >> appelAuDessus("+etageCourant+") ="+ret);
	...
	if (DEBUG) System.out.println(" >> appelEnDessous("+etageCourant+") ="+ret);
    	return ret;
    }
	...
	if (DEBUG) System.out.println(" >> destAuDessus("+etageCourant+") ="+ret);
    	return ret;
    }
	...
	if (DEBUG) System.out.println(" >> destEnDessous("+etageCourant+") ="+ret);
    	return ret;
    }
